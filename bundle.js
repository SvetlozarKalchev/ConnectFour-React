...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GameBoard = __webpack_require__(169);
	...
	_reactDom2.default.render(_react2.default.createElement(_GameBoard2.default, null), document.getElementById('container'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Column = __webpack_require__(256);
	...
	var _LockScreen = __webpack_require__(259);
	...
	var GameBoard = function (_Component) {
	  (0, _inherits3.default)(GameBoard, _Component);

	  function GameBoard(props) {
	    (0, _classCallCheck3.default)(this, GameBoard);

	    var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(GameBoard).call(this, props));

	    _this.state = { selectedColumn: null, lockScreen: null };
	    return _this;
	  }

	  (0, _createClass3.default)(GameBoard, [{
	    key: 'onColumnClick',
	    value: function onColumnClick(selectedColumn) {
	      this.setState({ selectedColumn: selectedColumn }, function () {});
	    }
	  }, {
	    key: 'startTurn',
	    value: function startTurn() {
	      // Activate lock screen
	      var lockScreen = this.state.lockScreen;
	      lockScreen.setState({ status: 'locked', message: 'Locked' });
	      ...
	      selectedColumn.placeNewDisk(selectedColumnHTML, function () {});
	      // Send the move data to the server
	    }
	  }, {
	    key: 'receiveLockScreenInstance',
	    value: function receiveLockScreenInstance(instance) {
	      this.setState({ lockScreen: instance });
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { 'class': 'game-board' },
	        _react2.default.createElement(_Column2.default, { onSelect: this.onColumnClick.bind(this) }),
	        _react2.default.createElement(_Column2.default, { onSelect: this.onColumnClick.bind(this) }),
	        _react2.default.createElement(_Column2.default, { onSelect: this.onColumnClick.bind(this) }),
	        _react2.default.createElement(_Column2.default, { onSelect: this.onColumnClick.bind(this) }),
	        _react2.default.createElement(_Column2.default, { onSelect: this.onColumnClick.bind(this) }),
	        ...
	        _react2.default.createElement(_Button2.default, { startTurn: this.startTurn.bind(this) }),
	        _react2.default.createElement(_LockScreen2.default, { sendInstanceToGameBoard: this.receiveLockScreenInstance.bind(this) })
	      );
	    }
	  }]);
	  return GameBoard;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Disk = __webpack_require__(257);
	...
	var Column = function (_Component) {
	  ...
	  function Column(props) {
	    ...
	    var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(Column).call(this, props));

	    _this.state = { focused: false, ref: 'null', class: 'col' };
	    return _this;
	  }
	  ...
	  (0, _createClass3.default)(Column, [{
	    ...
	    value: function selectColumn(event) {
	      ...
	      this.setState({ focused: false, ref: 'null', class: 'col' }, function () {

	        // After resetting the state, change the CSS class for all elements.
	        _this2.unfocusAll(function () {

	          // Then change the state of the selected column ONLY
	          _this2.setState({ focused: true, ref: 'selected', class: 'col focused' }, function () {});
	        });
	      });
	    }
	    ...
	    key: 'unfocusAll',
	    value: function unfocusAll(callback) {
	    ...
	    key: 'placeNewDisk',
	    value: function placeNewDisk(selectedColumn, callback) {
	      ...
	      for (var j = 0; j < cells.length; j++) {
	        ...
	        if (currentCell.innerHTML === '') {
	          ...
	          if (j === 5) {
	            _reactDom2.default.render(_react2.default.createElement(_Disk2.default, null), currentCell);
	          }
	          ...
	          // If the cell is NOT empty, put a disk in the one above it.
	            ...
	            if (j === 0) {
	              ...
	              _reactDom2.default.render(_react2.default.createElement(_Disk2.default, null), previousCell);
	            }
	          }
	      }
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: this.state.class, onClick: this.selectColumn.bind(this) },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Disk = function (_Component) {
	  (0, _inherits3.default)(Disk, _Component);

	  function Disk(props) {
	    (0, _classCallCheck3.default)(this, Disk);

	    var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(Disk).call(this, props));

	    _this.state = {
	      color: false // yellow/blue
	    };
	    return _this;
	  }
	  ...
	  (0, _createClass3.default)(Disk, [{
	    key: "determineColor",
	    value: function determineColor() {}
	  }, {
	    key: "render",
	    value: function render() {
	      var diskClass = "disk " + this.state.color;

	      return _react2.default.createElement("div", { className: diskClass });
	    }
	  }]);
	  return Disk;
	}(_react.Component);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Button = function (_Component) {
	  ...
	  function Button(props) {
	    ...
	    _this.state = { disabled: false, status: 'true' };
	    return _this;
	  }
	  ...
	  (0, _createClass3.default)(Button, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'button',
	        { className: 'select', ref: 'lock', enabled: this.state.disabled, onClick: this.startTurn.bind(this) },
	        'Make Move'
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LockScreen = function (_Component) {
	  (0, _inherits3.default)(LockScreen, _Component);

	  function LockScreen(props) {
	    (0, _classCallCheck3.default)(this, LockScreen);

	    var _this = (0, _possibleConstructorReturn3.default)(this, (0, _getPrototypeOf2.default)(LockScreen).call(this, props));

	    _this.state = { status: 'unlocked', message: 'Everything is fine.' };
	    return _this;
	  }
	  // Gets executed when the component get put in the DOM


	  (0, _createClass3.default)(LockScreen, [{
	    key: 'componentDidMount',
	    value: function componentDidMount() {
	      // Send this object instance to the GameBoard, so it can
	      // set it's state.
	      this.props.sendInstanceToGameBoard(this);
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { ref: 'lock', className: this.state.status },
	        _react2.default.createElement(
	          'p',
	          { className: 'lock-screen-message' },
	          this.state.message
	        )
	      );
	    }
